...
{
    /// <summary>
    /// 1 Состояние летящего блока
    /// N N
    /// L R
    /// </summary>
    public class FirstGameBlockState : GameBlockState
    {
        public override bool CanTurn(IGameField field)
        {
            return _gameBlock.Left.Row > 0 && field[_gameBlock.Left.Row - 1, _gameBlock.Left.Column + 1].Type == GameCellType.None;
        }
        ...
        public override void Turn()
        {
            ...
            _gameBlock.TransitionTo(new SecondGameBlockState());
        }
